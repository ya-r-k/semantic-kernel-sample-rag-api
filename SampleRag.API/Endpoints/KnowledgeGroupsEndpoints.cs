...
public static class KnowledgeGroupsEndpoints
{
    public static void MapKnowledgeGroupsEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPost("/", async ([FromBody] KnowledgeGroupData knowledgeGroup, IRepository<int, KnowledgeGroupData> groupRepository, CancellationToken ct) =>
        {
        ...
        group.MapGet("/", async (int batchSize, IRepository<int, KnowledgeGroupData> groupRepository, CancellationToken ct) =>
        {
